          ...
          >
            ...
            {plan.mostPopular && (
              <p className="
                ...
                rounded-full shadow-lg shadow-red-600/30
              ">
                Most Popular
              </p>
            )}
            ...
            <ul className="list-none text-gray-400 mt-6 space-y-3 text-left">
              {plan.features.map((feature, i) => (
                <li key={i} className="flex items-center gap-2">
                  <CheckIcon className="size-4.5 text-red-500" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
            ...
            <button
              ...
              className={`
                ...
                ${
                  plan.mostPopular
                    ? "bg-rose-600 hover:bg-red-700 text-white shadow-lg shadow-rose-600/30"
